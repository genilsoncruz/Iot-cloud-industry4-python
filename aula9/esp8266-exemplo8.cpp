// SENSOR + WIFI + ENVIO PARA GOOGLE SHEETS + LCD
...
// Configurações do LCD: Endereço 0x27, 16 colunas, 2 linhas
...
void inicializarLCD();
void mostrarLCD(float temperatura, float umidade);
...
void loop() {
    ...
    mostrarLCD(temperatura, umidade);
